...
<div class={`${!data ? 'flex' : 'hidden'} absolute w-full h-full items-center justify-center`}>
...
<div class={`${!data && 'hidden'} bg-white rounded-box shadow-xl p-5 w-90 flex mt-20 flex-col items-center`}>
